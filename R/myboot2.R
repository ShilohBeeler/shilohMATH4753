#' @title A bootstrapping function which finds confidence intervals for population parameters given sample statistics.
#'
...
#'
#' @return A graph of the sampled values, the point estimate, and the confidence interval, alongside a returned list of those values.
#' @export
#'
#' @examples
